...
export default async function AdminPartnersPage({
  ...
  const [{ data: partners }, { data: activity }] = await Promise.all([
    supabase
      .from("partners")
      .select(
        "id, name, address, phone, email, contact_name, contact_phone, alert_threshold, subscription_start, subscription_end, open_hour, close_hour, prize_frequency, prize_description, bank_account_number",
      )
      .order("name"),
    supabase
